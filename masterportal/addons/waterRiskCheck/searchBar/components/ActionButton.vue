...
export default {
    ...
    computed: {
        ...
        ...mapGetters("Modules/WaterRiskCheckSearchBar", ["showAllResults", "iconsByActions", "searchInputValue"])
    },
    methods: {
        ...mapActions("Modules/WaterRiskCheckSearchBar", [
            "activateAction"
        ]),
        ...mapMutations("Modules/WaterRiskCheckSearchBar", ["setSearchResultsActive", "setCurrentActionEvent"]),
        /**

...
export default {
    ...
    computed: {
        ...mapGetters("Modules/SelectionManager", Object.keys(getters)),
        ...mapGetters("Language", ["currentLocale"]),
        ...mapGetters("Modules/ColorCodeMap", ["upperEdge"]),
        ...mapGetters("Modules/DistrictSelector", ["name", "selectedDistrictLevel", "selectedFeatures", "label", "keyOfAttrName", "keyOfAttrNameStats", "loadend", "metadataUrls", "boundingGeometry", "bufferValue"]),
        ...mapGetters("Maps", ["getVisibleLayerList"]),
        ...mapGetters("Modules/FeaturesList", ["activeVectorLayerList", {facilitiesMapping: "mapping"}]),
        dashboardOpen () {
            return this.$store.getters["Modules/Dashboard/active"] || this.$store.getters["Modules/FeaturesList/active"];
        },
        selectionGroups () {
    ...
    methods: {
        ...mapMutations("Modules/SelectionManager", Object.keys(mutations)),
        ...mapActions("Modules/SelectionManager", Object.keys(actions)),
        ...
        allSelections () {
            ...
            this.addNewSelection({selection: flatArray, source: this.$t("additional:modules.cosi.selectionManager.title"), id: this.$t("additional:modules.cosi.selectionManager.allSelections") + " (" + this.selections.length + ")"});
            this.highlightSelection(this.selections.length - 1);
        ...
        connectSelections (selectionInc, indexArr) {
            ...
            this.addNewSelection({selection: selectionsCopy.flat(), source: this.$t("additional:modules.cosi.selectionManager.title"), id: this.$t("additional:modules.cosi.selectionManager.connectedSelections") + " (" + (selectionsCopy.length - 1) + ")"});
            this.highlightSelection(this.selections.length - 1);
        ...
        addBufferAsSelection (index) {
            this.addNewSelection({selection: this.selections[index].bufferedSelection, source: this.$t("additional:modules.cosi.selectionManager.title"), id: this.$t("additional:modules.cosi.selectionManager.buffer") + " " + this.selections[index].id});
        ...
        addMergedSelection () {
            ...
            this.addNewSelection({selection: flatArray, source: this.$t("additional:modules.cosi.selectionManager.title"), id: this.$t("additional:modules.cosi.selectionManager.mergedSelections") + " (" + this.selectionsToMerge.length + ")"});
            this.selectionsToMerge = [];
            this.highlightSelection(this.selections.length - 1);
        },
        /**
        ...
        >
            <div class="selection_menu">
                <div class="addon_head">
                    <p>{{ $t('additional:modules.cosi.selectionManager.title') }}</p>
                    <ToolInfo
                        :url="readmeUrl"
                ...
                >
                    <p class="menu_title">
                        {{ $t('additional:modules.cosi.selectionManager.allSelectionsMenu') }}
                    </p>
                    <button
                        class="all_btn"
                        :title="$t('additional:modules.cosi.selectionManager.title_all_selections')"
                    ...
                    <button
                        class="connect_btn"
                        :title="$t('additional:modules.cosi.selectionManager.title_connect_selections')"
                    ...
                    <button
                        ...
                        :title="$t('additional:modules.cosi.selectionManager.title_remove_all')"
                ...
                >
                    <div class="cache_head head">
                        <div class="function_buttons cache_buttons">
                            <p class="menu_title">
                                {{ $t('additional:modules.cosi.selectionManager.cache') }}
                            </p>
                            <button
                                v-if="selectionsToMerge.length > 0"
                                :title="$t('additional:modules.cosi.selectionManager.title_merge')"
                                class="combine_btn"
                    ...
                    <ul class="cache_selections">
                        ...
                        >
                            ...
                            <button
                                ...
                                :title="$t('additional:modules.cosi.selectionManager.title_remove_cached_selection')"
                            ...
                            <template v-for="(selection, i) in selections">
                                ...
                                >
                                    ...
                                    >
                                        <button
                                            class="view_btn"
                                            :title="$t('additional:modules.cosi.selectionManager.title_view')"
                                            :class="{
                                        ...
                                        <button
                                            v-if="selections.length > 1"
                                            :title="$t('additional:modules.cosi.selectionManager.title_add')"
                                            class="add_btn"
                                            :class="{
                                        ...
                                        <button
                                            ...
                                            :title="selection.storedLayers.length > 0 ? selection.storedLayers.join(', ') : $t('additional:modules.cosi.selectionManager.title_stored')"
                                            @click="storeLayers(i)"
                                        >
                                        ...
                                        <button
                                            :title="$t('additional:modules.cosi.selectionManager.title_extended_options')"
                                            class="option_btn"
                                        ...
                                        <button
                                            :title="$t('additional:modules.cosi.selectionManager.title_remove')"
                                            class="remove_btn"
                                    ...
                                    <div class="extended_options">
                                        ...
                                        <v-slider
                                            ...
                                            min="-1500"
                                            step="10"
                                            :title="$t('additional:modules.cosi.selectionManager.title_slider')"
                                            @input="polygonChange(i)"
                                        />
                                        <button
                                            :title="$t('additional:modules.cosi.selectionManager.title_toggle_buffer')"
                                            class="activate_btn"
                                        ...
                                        <button
                                            ...
                                            :title="$t('additional:modules.cosi.selectionManager.title_buffer_selection')"

...
export default {
    ...
    computed: {
        ...
        ...mapGetters("Modules/CosiFileImport", Object.keys(getters)),
        ...mapGetters("Modules/FeaturesList", ["layerMapById"]),
    ...
    methods: {
        ...mapActions("Modules/CosiFileImport", [
            "importKML",
            "passLayer",
            "deleteLayerFromTree",
            "setSelectedFiletype"
        ...
        ...mapActions("Modules/FeaturesList", ["addVectorlayerToMapping", "removeVectorLayerFromMapping"]),
        ...mapMutations("Modules/CosiFileImport", Object.keys(mutations)),
        ...mapMutations("Modules/CalculateRatio", ["setFacilityMappingUpdate"]),
         ...
         * @param {String} filename - Name of the file whose layer should be removed.
         * @returns {void}
         */
        removeLayer (filename) {
            try {
                this.$store.dispatch("Modules/CosiFileImport/deleteLayerFromTree", filename);
            }
            catch (err) {

...
import omit from "../../../../../src_3_0_0/shared/js/utils/omit";
import {extractEventCoordinates} from "../../../../../src_3_0_0/shared/js/utils/extractEventCoordinates";
import {getWKTGeom} from "../../../../../src_3_0_0/shared/js/utils/getWKTGeom";
...
export default {
    ...
    computed: {
        ...mapGetters("Modules/GetFeatureInfo", ["gfiFeatures"]),

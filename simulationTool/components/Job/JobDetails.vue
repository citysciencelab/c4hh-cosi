...
import DiagrammComponent from "../Diagramm/DiagrammComponent.vue";
...
export default {
    ...
    computed: {
        ...
        ...mapGetters("Modules/SimulationTool", ["selectedJobId", "jobResultData", "simulationApiUrl"]),
    ...
    unmounted () {
        ...
        if (this.job) {
            const layerObject = this.layerConfigById(this.job.jobID);
        ...
        initMapFilters () {
            ...
            this.mapFilters = this.job.results_metadata.values
                .map((filterEntry) => {
                    ...
                    filter.key = key;
                    filter.active = false;
                    filter.value = type === "string" ? values[0] : min;
...
<template>
    <div class="job-details segment-wrapper">
        <SectionHeader
            ...
            icon="bi-box-fill"
        />
        <AsyncWrapper :async-state="jobRequestState">
            <div
                v-if="job"
                class="details-body"
            >
                ...
                <div class="parameter segment-wrapper">
                    ...
                    <ul v-if="jobSelectVisible">
                        <li
                            v-for="(value, key) in job?.parameters.inputs"
                            :key="key"
                        >
                ...
                <div class="charts segment-wrapper">
                    ...
                    <AsyncWrapper :async-state="resultRequestState">

...
export default {
    ...
    retrieveCapabilites: function ({state, dispatch, rootGetters, commit}) {
        let serviceUrl = rootGetters.restServiceById(state.printServiceId).url;
     ...
     * @returns {void}
     */
    parseCapabilities: function ({dispatch}, response) {
     ...
     * @returns {void}
     */
    parseMapfishCapabilities: function ({commit, dispatch, rootGetters}, response) {

import {fetchRoutingOrsDirections} from "../../../../src_3_0_0/modules/routing/js/directions/routing-ors-directions.js";
...
function getFeaturesAndRouting (coordinate, features, speedProfile, onstart, onsuccess, onerror, result = [], idx = 0) {
    ...
    onstart(i18next.t("additional:modules.valuationPrint.pleaseWait"));

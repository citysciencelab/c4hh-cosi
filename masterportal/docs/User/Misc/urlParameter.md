...
|HIGHLIGHTED3D|Highlights a 3D Tiles feature by its feature ID. The parameter expects the feature's unique identifier. The 3D view must be active (`MAPS={"mode":"3D"}`).|`&HIGHLIGHTED3D=DEHHALKAJ0000pBE`|

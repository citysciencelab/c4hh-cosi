 ...
 * npm run test:watch -- --grep="addons/vpiDashboard/test/ ADDON: VPI Dashboard"
 */
describe("addons/vpiDashboard/test/ ADDON: VPI Dashboard", () => {
    ...
    describe("testing default values", () => {
        it("returns the name default value from state", () => {
            expect(name(stateVpiDashboard)).to.be.equals("additional:modules.tools.vpidashboard.name");
        });

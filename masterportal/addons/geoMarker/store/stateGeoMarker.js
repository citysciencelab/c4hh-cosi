...
const state = {
    ...
    categories: [],
    departments: [],
    geoMarkerWfsFeatureType: "geomarker_nobase64",
    geoMarkerWfsFeatureIdPrefix: "DE.HH.UP_GEOMARKER_NOBASE64_",
    ...
    geoMarkerEditLayerFeatureType: "geomarker",
    geoMarkerEditLayerFeatureIdPrefix: "DE.HH.UP_GEOMARKER_",

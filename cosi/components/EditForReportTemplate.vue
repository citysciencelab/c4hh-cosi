...
export default {
    ...
    computed: {
        validationStatus () {
            if (!Array.isArray(this.settingsIssues) || this.settingsIssues.length === 0) {
    ...
    methods: {
        ...mapActions("Modules/ReportTemplates", ["finishEditingToolSettings", "abortEditingToolSettings"]),
        stopEditing () {

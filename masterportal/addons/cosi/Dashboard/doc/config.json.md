...
|fixedHeader|nein|Boolean|false|Wenn der Parameter auf `true` gesetzt ist, wird beim Export eine vorgegebene Spalten-Reihenfolge vorgenommen.|
|trendColors|nein|String/String[]|""|Die Farben des Trendpfeils.|

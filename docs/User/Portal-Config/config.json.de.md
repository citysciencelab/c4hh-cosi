...
Dieses Tool ermöglicht es Benutzern, zwei Layer nebeneinander mit einem Layer-Swiper zu vergleichen. Benutzer wählen Layer aus den aktiven, sichtbaren Layern aus, und der Swiper teilt die Karte, um jeden Layer in separaten Abschnitten anzuzeigen. Das Tool unterstützt keine Gruppen-Layer.
...
|shouldSubjectDataSelectedInTree|no|Boolean|false|Filter werden nur angezeigt, wenn der jeweilig Layer im Themenbaum ausgewählt ist.|false|
...
|enableUndoRedo|nein|Boolean|false|Aktiviert die Messungsliste mit punktgenauem Undo/Redo für aktive Skizzen und abgeschlossene Messungen. Im 3D-Modus nicht verfügbar.|false|
|icon|nein|String|"bi-arrows-angle-expand"|Icon das im Menü vor dem Modulnamen angezeigt wird. Zur Auswahl siehe **[Bootstrap Icons](https://icons.getbootstrap.com/)**|false|

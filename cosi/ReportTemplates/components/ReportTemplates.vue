...
export default {
    ...
    computed: {
        ...
        ...mapGetters("Modules/ReportTemplates", Object.keys(getters)),
        ...mapGetters("Modules/ToolBridge", ["currentSettings"]),
        ...mapGetters("Maps", {getMapView: "getView"}),
        ...mapGetters("Modules/SelectionManager", ["lastSelectionWithCurrentDataLayers"]),
        ...mapGetters("Modules/DistrictSelector", ["selectedDistrictNames"])
            ...
            const reader = new FileReader(),
                ...
                updateTemplateItems = (() => { // callback when file is read: replace templateItem array
                    ...
                    return (newItems) => {
                        ...
                        this.$store.state.Modules.ReportTemplates.templateItems = newItems;
    ...
    methods: {
        ...mapActions("Modules/ReportTemplates", ["startEditingToolSettings", "finishEditingToolSettings", "abortEditingToolSettings", "returnToReportTemplatesInterface"]),
        ...mapActions("Alerting", ["addSingleAlert", "cleanup"]),
        ...mapMutations("Modules/ReportTemplates", Object.keys(mutations)),
        ...mapActions("Modules/ToolBridge", ["runTool"]),
        ...mapActions("Maps", ["zoomToExtent"]),
        ...mapActions("Modules/ExportPDF", ["reportTemplateToPDF"]),
        ...mapMutations("Modules/SelectionManager", ["addSelection", "setActiveSelection", "setAcceptSelection"]),
        ...
        openToolInterface (toolName, closeReportTemplates = true) {
            this.$store.commit("Modules/" + toolName + "/setActive", true);
        ...
        <v-container class="main_container">
            ...
            <v-row class="mt-5">
                <v-col>
                    ...
                    <v-row>
                        <h4>{{ $t('additional:modules.cosi.reportTemplates.chooseTemplate') }}</h4>
                    </v-row>
                    <v-row class="">

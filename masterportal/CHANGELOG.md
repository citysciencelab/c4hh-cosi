...
- Vite:
    ...
    - BuildExamples: Stabilized the examples build by fixing multiple issues.
...
- WMS-Time: Only valid time attributes will now be appended to the request when the layer is turned on.

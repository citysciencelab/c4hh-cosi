...
export default {
    ...
    computed: {
        ...mapGetters("Modules/QuickResponseCode", Object.keys(getters))
    },
    watch: {
    ...
    methods: {
         ...
         * @param {Number[]} coordinates An array with two entries for longitude and latitude coordinates in map projection (e.g. EPSG:25832)
         * @returns {void}
         */
        ...
        transformCoords (coordinates) {
            return crs.transform(mapCollection.getMapView("2D").getProjection().getCode(), this.urlSchemaTargetProjection, coordinates);
        },
        /**
         * Resets the value of qrDataUrl.
         * @returns {void}
         */
        resetQrDataUrl () {
            this.qrDataUrl = null;

 ...
 * @property {Object.<string, [string, string]>} pointImages - Mapping of point marker color keys to KML color values and icon image paths.
 * @property {Object.<string, string>} textColors - Mapping of text color labels to KML color values.
 * @property {Object.<string, number>} textSizes - Mapping of text size labels to scale factors.
 * @property {Boolean}  onlyDesktop - if true, component is available on desktop devices only
